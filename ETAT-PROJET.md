...
- **Traduction FR** → digest développé en français (articles [EN] réécrits en 4-6 phrases), uploadée sur Drive privé à chaque run + lien ajouté au message Discord ; jamais publiée sur le wiki public
